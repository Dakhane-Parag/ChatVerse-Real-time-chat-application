...
const ProfilePage = () => {
  ...
  return (
    <div className="min-h-screen bg-cover bg-no-repeat flex items-center justify-center">
      <div className=" max-w-2xl backdrop-blur-2xl text-gray-300 border-2 border-gray-600 flex items-center justify-between max-sm:flex-col-reverse rounded-lg">
        <form action="" onSubmit={handleSubmit} className="flex flex-col gap-5 p-10 flex-1">
          ...
          <textarea onChange={(e) => setBio(e.target.value)} value={bio} name="" placeholder="profile bio" required className="p-2 border border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-violet-500 " rows={4}></textarea>
          <button type="submit" className="bg-gradient-to-r from-purple-400 to-violet-900 text-white p-2 rounded-full text-lg cursor-pointer">Save</button>
        </form>
